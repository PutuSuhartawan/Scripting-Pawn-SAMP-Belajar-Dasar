...
CMD:readdinidata(playerid)
{
    ...
    new notif[200];
    format(notif, 200, ""COL_LGREEN"DINI DATABASE:"COL_WHITE" You take query from Dini is: %s value", pInfo[playerid][PasswordAccount]);
...
CMD:writeindinidata(playerid, params[])
{
       ...
       new notif[200];
        format(notif, 200, ""COL_LGREEN"DINI DATABASE:"COL_WHITE" You save query to Dini is: %s String value", params);
        SendClientMessage(playerid, COLOR_LBLUE, notif);
}
